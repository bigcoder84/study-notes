# 为什么常说MySQL单表数据量建议在2000w行内

> 本文转载至：[MySQL 单表不要超过 2000W 行，靠谱吗？ | 小林coding (xiaolincoding.com)](https://www.xiaolincoding.com/mysql/index/2000w.html#单表建议值)
...
- 索引结构不会影响单表最大行数，2000W 也只是推荐值，超过了这个值可能会导致 B + 树层级更高，影响查询性能，如果MySQL内存充足，能将所有数据放入内存中，那就不会存在查询效率的问题了。