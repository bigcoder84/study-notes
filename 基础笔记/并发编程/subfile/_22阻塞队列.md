...
public class Test {
    ...
    private static class Productor implements Runnable {
        ...
        public Productor(BlockingQueue<String> blockingQueue) {
            this.blockingQueue = blockingQueue;
        }
    ...
    public static void main(String[] args) {
        ...
        new Thread(new Consumer(queue),"消费者一").start();
        new Thread(new Consumer(queue),"消费者二").start();
        new Thread(new Consumer(queue),"消费者三").start();

        new Thread(new Productor(queue),"生产者一").start();
        new Thread(new Productor(queue),"生产者二").start();
        new Thread(new Productor(queue),"生产者三").start();
    }
}
```
