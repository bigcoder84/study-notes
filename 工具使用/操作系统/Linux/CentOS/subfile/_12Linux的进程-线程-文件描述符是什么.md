...
> 本文转载至：[Linux 的进程-线程-文件描述符是什么 | labuladong 的算法小抄 (gitee.io)](https://labuladong.gitee.io/algo/di-si-zhan-4baf4/linux-de-j-5a108/)
...
> 不要忘了，Linux 中一切都被抽象成文件，设备也是文件，可以进行读和写。
